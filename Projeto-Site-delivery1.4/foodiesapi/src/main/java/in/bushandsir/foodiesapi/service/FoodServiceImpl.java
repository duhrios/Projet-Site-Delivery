...
import in.bushandsir.foodiesapi.entity.FoodEntity;
import in.bushandsir.foodiesapi.io.FoodRequest;
import in.bushandsir.foodiesapi.io.FoodResponse;
import in.bushandsir.foodiesapi.repository.FoodRepository;
...
public class FoodServiceImpl implements FoodService {
    ...
    public String uploadFile(MultipartFile file) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "An error ocurred while uploading the file ");
